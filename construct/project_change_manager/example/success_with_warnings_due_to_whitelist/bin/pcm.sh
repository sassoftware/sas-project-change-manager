...
export PCM_LOG_ROOT=$PCM_ROOT/example/success_with_warnings_due_to_whitelist/log
export PCM_CHANGESET_AUTOEXEC=
export PCM_INSTALLS_LOC=$PCM_ROOT/example/success_with_warnings_due_to_whitelist/installs
