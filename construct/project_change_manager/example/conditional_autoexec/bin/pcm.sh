...
export PCM_LOG_ROOT=$PCM_ROOT/example/conditional_autoexec/log
export PCM_CHANGESET_AUTOEXEC=$PCM_ROOT/example/conditional_autoexec/autoexec/conditional_autoexec.sas
export PCM_INSTALLS_LOC=$PCM_ROOT/example/conditional_autoexec/installs
